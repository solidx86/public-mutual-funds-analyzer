...
1. Construct the path: `unit-trust/product-highlight-sheet-phs/<Abbr>_PHS.pdf` where
...
In a prior re-recommendation (a Moderate client, May 2026), the PISTF→PITSEQ replacement card
...
- **PHS Lookup Rule (Step 6):** every Sales Charge / Mgmt Fee / Trustee Fee value in both the
  ...
  `unit-trust/product-highlight-sheet-phs/<Abbr>_PHS.pdf`. The mini-card's `.source`
