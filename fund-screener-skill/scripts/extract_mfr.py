...
BASE_DIR = os.path.join(_FUNDS_DIR, "unit-trust")
PHS_DIR  = os.path.join(_FUNDS_DIR, "unit-trust", "product-highlight-sheet-phs")
OUT_DIR  = os.path.join(_FUNDS_DIR, "data", "cache")
...
if __name__ == "__main__":
    ...
    with open(os.path.join(OUT_DIR, "mfr_results.json"), "w") as fp:
        json.dump({'all_funds': all_funds, 'qualified': qualified,
                   'base_dir': os.path.relpath(BASE_DIR, _FUNDS_DIR)}, fp, indent=2)
