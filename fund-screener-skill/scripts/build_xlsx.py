...
def _mfr_labels():
    ...
    mfr_path = os.path.join(WORK_DIR, "data", "cache", "mfr_results.json")
    try:
...
# ── Load data ────────────────────────────────────────────────────────────────
rows = read_csv(os.path.join(WORK_DIR, "data", "cache", "master_funds.csv"))
mfr_data = json.load(open(os.path.join(WORK_DIR, "data", "cache", "mfr_results.json")))

# ── ATH data (v6) ─────────────────────────────────────────────────────────────
ath_path = os.path.join(WORK_DIR, "data", "cache", "ath_results.json")
ath_map = {}
