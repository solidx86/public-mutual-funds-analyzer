...
CACHE_DIR        = os.path.join(FUNDS_DIR, "data", "cache")
os.makedirs(CACHE_DIR, exist_ok=True)
OUTPUT_PATH      = os.path.join(CACHE_DIR, "ath_results.json")
MFR_RESULTS      = os.path.join(CACHE_DIR, "mfr_results.json")
CODE_MAP_PATH    = os.path.join(CACHE_DIR, "fund_code_map.json")  # persisted cache
