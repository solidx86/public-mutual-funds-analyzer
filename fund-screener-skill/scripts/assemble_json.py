...
ath_path = os.path.join(FUNDS_DIR, "data", "cache", "ath_results.json")
os.makedirs(os.path.dirname(ath_path), exist_ok=True)
...
cm_path = os.path.join(FUNDS_DIR, "data", "cache", "fund_code_map.json")
